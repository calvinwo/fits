...
/** This class represents a Mix object, with various convenient functions for use
 * by XmlContentConverter in building up the structure. It's a captive class
 * with no public interface, so data fields are directly accessible. */
public class MixModel
{
    ...
    protected MixModel ()
    {
        ...
        try
        {
            // Add the top-level elements to the mix element, to make life
            // simpler.
            ...
            // Here are some pieces which are constructed once, but added only
            // if they're needed.
            ...
            sfc = new SpecialFormatCharacteristics(); // Add this to bii if
                                                      // needed
            ...
            // Build DigitalCameraCapture with subelements, but don't hook it to
            // icm
            // until it's needed.
    ...
    {
        // I assume there's only a single value provided, and that it's an
        // integer.
    ...
    {
        /*
         * This consists of a series of six numbers, separated by spaces, each
         * of which is a headroom-footroom pair. The second argument tells us
         * whether the components are yCbCr or RGB. For the current cut, assume
         * YCbCr.
         */
        StringTokenizer tok = new StringTokenizer(data);
    ...
    /** Parse the longitude or latitude string from ExifTool. This is in a rather
     * ugly format, like this: 33 deg 24' 51.80" N */
