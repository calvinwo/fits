...
public interface Tool extends Runnable
{
    ...
    {
        SHOULDNOTRUN, SHOULDRUN, FAILED, SUCCESSFUL
    };

    /** Extracts the identification and metadata from the provided file
     * 
     * @param file the file to have its metadata extracted
     * @return tooloutput object containing the xml wrapping the tool raw
     *         output, fits compatible xml output and the fits FileIdentity
     * @throws FitsToolException */
    public ToolOutput extractInfo (File file) throws FitsToolException;

    /** Checks if the value for the given field name is the default value that
     * the tool would report if it doesn't understand the file that was
     * processed
     * 
     * @param identity the identity to test
     * @return boolean indicating the file is a known or unknown type for the
     *         tool */
    ...
    /** Checks if the tool excluded extensions list contains the provided
     * extension
     * 
     * @param ext
     * @return boolean */
    ...
    /** Checks if the tool included extensions list contains the provided
     * extension
     * 
     * @param ext
     * @return boolean */
