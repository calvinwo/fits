...
{
    private final static Namespace xsiNS               = Namespace
                                                               .getNamespace("xsi",
    ...
    {
        log.debug("Entering XmlMetadata()");
        info.setName("OIS XML Metadata");
        info.setVersion("0.2");
        info.setDate("12/22/10");
        log.debug("Exiting XMLMetadata()");
    }
        ...
        if (file.getPath().toLowerCase().endsWith(".xml"))
        {
            ...
            if (xml != null)
            {
                ...
                if (schemaNS != null)
                {
                    ...
                    noNamespaceSchemaLocation = xmlRoot.getAttributeValue(
                            "noNamespaceSchemaLocation", schemaNS);
                }
                ...
                if (schemaLocations != null && schemaLocations.length() > 0)
                {
                    ...
                    for (int i = 0; i < locations.length; i++)
                    {
                        ...
                        && noNamespaceSchemaLocation.length() > 0)
                {
