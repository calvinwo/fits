...
public class FormatDescription implements Comparable<Object>
{
    ...
    /** Add a single file extension to the internal list of typical file
    ...
    /** Add all file extensions to the internal list of typical file extensions
     * for this format.
     * 
    ...
    /** Add a single MIME type to the internal list of MIME types for this
     * format.
     * 
