...
public class Jhove extends ToolBase
{
    ...
    private final static Logger  log             = LoggerFactory
                                                         .getLogger("edu.harvard.hul.ois.fits.tools.jhove");
    ...
    public Jhove () throws FitsException
    {
        try
        {
            ...
            xh = new XmlHandler();
            jhoveApp = new App("Jhove", "1.9", new int[] { 2009, 12, 23 }, "", "");
            xh.setApp(jhoveApp);
            xh.setBase(jhove);
        }
        ...
        log.debug("Exiting Jhove()");
    }

    /** Invokes Jhove in 'signature mode', where the header of the file is
     * examined to determine the format, and thus which Jhove Module should be
    ...
    {
        log.trace("Entering characterize(file={})", file);
        jhove.setSignatureFlag(true);
        Document dom = getFileInfo(file, null);
        jhove.setSignatureFlag(false);
        log.trace("Exiting charactize(): {}", dom);
        return dom;
    }

    /** Invokes Jhove against a file, returning the DOM representation of the
     * Jhove XML.
     * 
    ...
    {
        log.trace("Entering getFileInfo(file={}, mod={}", file, mod);
        ...
        out.close();
        log.trace("Exiting getFileInfo(): {}", dom);
        return dom;
    }
    ...
    public ToolOutput extractInfo (File file) throws FitsToolException
    {
        ...
        /*
         * debug code XMLOutputter outputter = new
         * XMLOutputter(Format.getPrettyFormat()); try { outputter.output(dom,
         * System.out); } catch (IOException e) { // TODO Auto-generated catch
     ...
     * identity.getMime(); if((format.equals("bytestream") ||
