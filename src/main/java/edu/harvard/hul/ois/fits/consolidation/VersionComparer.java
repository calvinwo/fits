...
public final class VersionComparer implements Serializable , Comparable<VersionComparer>
{
    ...
    private final static Logger log              = LoggerFactory
                                                         .getLogger("edu.harvard.hul.ois.fits.consolidator");
    ...
    {
        log.trace("Entering parseString(str={})", str);
        major = 0;
        minor = 0;
        build = 0;
        name = ""; //$NON-NLS-1$
    ...
    {
        log.trace("Entering VersionComparer(aMajor={}, aMinor={}, aBuild={}, aName={}", aMajor,
                aMinor, aBuild, aName);
        major = aMajor;
        minor = aMinor;
        build = aBuild;
        name = (aName == null) ? "" : aName; //$NON-NLS-1$
        log.trace("Exiting VersionComparer()");
    }
