...
public class AESModel
{
    ...
    protected void setCodecCreatorApplicationVersion (String codecCreatorAppVersion)
     ...
     * @param frequency
     * @throws XmlContentException */
    protected void setDuration (String time, int editRate, long numSamples)
            throws XmlContentException
    {
    ...
    private EditUnitNumber getEditUnitNumber (String time, int editRate, long numSamples,
            String elementName)
    {
    ...
    protected void addStream (int channelNum, double leftRightPos, double frontRearPos)
            throws XmlContentException
    {
