...
{
    private final static Namespace xsiNS   = Namespace.getNamespace("xsi",
    ...
    private Document createXml (File file) throws FitsToolException
    {
        ...
        // } catch (IOException e) {
        // throw new
        // FitsToolException("Could not calculate the MD5 for "+file.getPath(),e);
        // }
        // fslastmodified
