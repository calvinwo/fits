...
public class FitsOutput
{
    ...
    /** Return the metadata element with given name.
     * 
     * @param name
     * @return */
    ...
    /** Return the list of metadata elements with the given name.
     * 
     * @param name
     * @return */
    ...
    /** Check if the metadata exists using given name
     * 
     * @param name
     * @return */
    ...
    /** Checks if there are any conflicts with the metadata using the given name
     * 
     * @param name
     * @return */
    ...
    /** Creates the metadata element list and returns the list.
     * 
     * @param parent
     * @return */
    @SuppressWarnings("unchecked")
    private List<FitsMetadataElement> buildMetadataList (Element parent)
    {
    ...
    /** Creates and populates the FitsMetadataElement object and returns it.
     * 
     * @param node
     * @return */
    ...
    /** Save the Fits metadata to disk.
     * 
     * @param location
     * @throws IOException */
    ...
    /** Outputs the Fits metadata to OutputStream.
     * 
     * @param outstream
     * @throws IOException */
    ...
    /** Checks the well-formedness of the file.
     * 
     * @return */
    ...
    public void addStandardCombinedFormat () throws XMLStreamException, IOException, FitsException
    {
        ...
        if (techmd != null && techmd.getChildren().size() > 0)
        {
            ...
            // convert the std xml back to a JDOM element so we can insert it
            // back into the fitsXml Document
            try
            {
    ...
    /** Returns the total time it takes for the tools to finish
     * 
     * @param toolBelt
     * @param ext
    ...
    public void createStatistics (ToolBelt toolBelt, String ext, long totalExecutionTime)
    {
        ...
        {
            // if the tool should have been used for the file, else ignore it
            ...
            // else if the tool should have run but never changed to a
            // successful state
